      ...
      <div className='min-h-screen flex flex-col justify-center items-center m-0 bg-black'>
          <div className="form-container flex flex-col items-center justify-center text-white rounded p-3 w-1/3">
              ...
              <form action="" className='w-full mx-[20px]' onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className='w-full bg-blue-600 border-none rounded px-3 py-2 text-white hover:bg-blue-700 my-3 pointer'>{loading ? 'Logging In...' : 'Login'}</button>
              </form>
              <p className="py-2 text-center">Don't have an account? <Link to='/register' className='text-blue-800 underline pointer'>Register here!</Link></p>
          </div>
      </div>
    )
}
